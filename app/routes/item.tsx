...
export function meta({params}: Route.MetaArgs) {
    return [
        ...
        {name:"description", content:"Edit or delete the current item"},
    ]
}
...
export default function Item({loaderData, actionData }: Route.ComponentProps) {
    ...
    return (
        <div className="max-w-md mx-auto">
            ...
            {actionData?.updated && <div className="bg-green-200 text-green-800 p-2 mb-4 rounded">
                Item updated successfully!
                </div>}
            {actionData?.error && <div className="bg-red-200 text-red-800 p-2 mb-4 rounded">
                { actionData.error }
                </div>}
